...
from soundsmanager import SoundsManager
...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        ...
        if len(self.bullets) < self.settings.bullets_allowed:
            ...
            self.soundsmanager.shoot_sound.play()
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            self.soundsmanager.ship_left_sound.play()
            self.sb.prep_ships()
            # Get rid of any remaining aliens and bullets.
            self._reset_battlefield()
            # Pause.
    ...
    def _get_rows_alien(self, alien):
        """Get rows alien."""
